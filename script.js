...
function initCharts() {
    document.getElementById('interactive-chart-tab1').innerHTML = generateChartHTML('tab1', false); // Static
    document.getElementById('interactive-chart-tab2').innerHTML = generateChartHTML('tab2', true);  // Interactive
    document.getElementById('interactive-chart-tab3').innerHTML = generateChartHTML('tab3', true);  // Interactive
...
function updateComparisonStack() {
    ...
    // Generate Vertical Dotted Reference Lines based on Tab 1
    ...
    const createComparisonBlock = (tabId, title) => {
        return `
            <div class="comparison-block">
                <span class="comparison-title" style="font-size: 0.9rem; margin-bottom: 0;">${title}</span>
    ...
    const blocksHTML = 
        createComparisonBlock('tab1', "In Ideal Setting") +
        createComparisonBlock('tab2', "In Islamic Practice") +
        createComparisonBlock('tab3', "In Secular Practice");
